        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative z-10 w-full max-w-2xl h-[80vh] bg-white rounded-md shadow-lg flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-auto p-4">
                    {visible.length === 0 && <div className="text-sm text-gray-500">No comments yet. Be the first to comment.</div>}
                    ...
                    {end < comments.length && (
                        <div className="mt-4 text-center">
                            <button className="px-4 py-2 bg-gray-100 rounded" onClick={() => setPage(p => p + 1)}>Show more</button>
                        </div>
                    )}
                </div>
                ...
                <div className="p-3 border-t bg-white">
                    <div className="flex gap-2">
                        ...
                        />
                        <button className="px-4 py-2 bg-blue-600 text-white rounded" onClick={handleAdd}>Send</button>
